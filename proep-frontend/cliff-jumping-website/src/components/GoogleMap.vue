              ...
              (function(marker, i) {
                return function() {
                  content = '<div id="content">'+
                            '<div id="siteNotice">'+
                              '</div>'+
                              '<h1 id="firstHeading" class="firstHeading">'+vm.Markers[i].Name+'</h1>'+
                              '<div id="bodyContent">'+
                              '<p><b>Difficulty Level: </b>'+vm.Markers[i].difficultyLevel+'</p>'+
                              '<p><b>Height : </b>'+vm.Markers[i].height+'</p>'+
                              '<p><b>Rating : </b>'+vm.Markers[i].rate+'</p>'+
                              '</div>'+
                              '</div>';
